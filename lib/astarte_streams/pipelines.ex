...
defmodule Astarte.Streams.Pipelines do
  require Logger
  ...
  defp pipelines_dir do
    default = Application.app_dir(:astarte_streams, ["priv", "pipelines"])

    Application.get_env(:astarte_streams, :pipelines_dir, default)
  end
end
