...
defmodule Astarte.FlowWeb.Plug.GuardianAuthorizePath do
  use Plug.Builder
  ...
  alias Astarte.FlowWeb.FallbackController

  plug Guardian.Plug.Pipeline,
    otp_app: :astarte_flow,
    module: Astarte.Flow.Auth.Guardian,
    error_handler: FallbackController

  plug Astarte.FlowWeb.Plug.VerifyHeader
  plug Guardian.Plug.EnsureAuthenticated
  plug Guardian.Plug.LoadResource
  plug :authorize

  @spec authorize(conn :: Plug.Conn.t(), opts :: term) :: Plug.Conn.t()
  ...
  defp build_auth_path(conn) do
    with %{"realm" => realm} <- conn.path_params,
